...
const PremiumSection = ({ children, title, icon, theme = 'experience', className = '' }: {
  ...
  const getBackgroundGradient = (theme: string) => {
    ...
    return gradients[theme as keyof typeof gradients] || gradients.experience;
  };
  ...
  const experiences = [
    {
      ...
      achievements: [
        ...
        },
        {
          ...
          icon: <HeartHandshake size={18} className="text-orange-500" />,
        },
      ],
    ...
    },
    {
      ...
      role: {
        en: 'Founder & Developer | 2025-Present',
        bn: 'প্রতিষ্ঠাতা ও ডেভেলপার | ২০২৫-বর্তমান',
      },
      links: [
        {
          label: {
      ...
      achievements: [
        {
          description: {
            en: 'All in one shopping platform',
            bn: ' সব এক শপিং প্ল্যাটফর্মে',
          },
          icon: <Target size={18} className="text-orange-500" />,
        },
        {
          description: {
            en: 'All daily necessities are available including the website source code',
            bn: 'ওয়েবসাইটের সোর্স কোড সহ সকল নিত্যপ্রয়োজনীয় জিনিসপত্র পাওয়া যায়',
          },
          icon: <HeartHandshake size={18} className="text-orange-500" />,
        },
      ],
