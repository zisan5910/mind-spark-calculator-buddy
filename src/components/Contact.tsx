...
const PremiumSection = ({ children, title, icon, theme = 'contact', className = '' }: {
  ...
  const getBackgroundGradient = (theme: string) => {
    ...
    return gradients[theme as keyof typeof gradients] || gradients.contact;
  };
  ...
  const contactData = {
    ...
    items: [
      ...
      },
      {
        ...
        content: {
          en: 'linkedin.com/in/ridoan-zisan',
          bn: 'linkedin.com/in/ridoan-zisan',
        },
